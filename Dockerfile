...
USER root
RUN yum -y update && yum -y install httpd && yum -y install rsync && yum -y install openssh-server && echo "root:Docker!" | chpasswd && yum clean all 
